...
class CardTag(models.Model):
    ...
    card = models.ForeignKey(Card, on_delete=models.CASCADE, db_column='CardID', verbose_name='Карточка')
    tag = models.ForeignKey(Tag, on_delete=models.CASCADE, db_column='TagID', verbose_name='Тег')
